...
{
    public partial class _1LandAnimals : Form
    {
        ...
        public _1LandAnimals()
        {
            InitializeComponent();
            /*
                        // Set up the Timer
                        zoomTimer = new Timer();
                        zoomTimer.Interval = timerInterval;
                        zoomTimer.Tick += timer1_Tick;

                        // Calculate the number of ticks and the zoom direction
                        zoomTicks = zoomTime / timerInterval;
                        scaleFactor = startScaleFactor; // Start at no zoom
                        zoomingIn = true; // Start by zooming in

                        // Set PictureBox properties
                        pictureBox3.SizeMode = PictureBoxSizeMode.Zoom;
                        pictureBox3.Image = // ... your initial image ...
                            */
        ...
        private void ApplyZoomEffect(PictureBox pBox, double factor)
        {
            // Create a new Bitmap with the zoomed size
            Image img = pBox.InitialImage;
            Bitmap bmp = new Bitmap(img, new Size((int)(img.Width * factor), (int)(img.Height * factor)));
            pBox.Image = bmp;

            // You may need to dispose the old Bitmap if you're not using InitialImage
            // if (pBox.Image != null)
            // {
            //     pBox.Image.Dispose();
            // }
        ...
        private void ApplyPopUpEffect(PictureBox pictureBox)
        {
            ...
            pictureBox.MouseEnter += prevButton_MouseEnter;
            pictureBox.MouseLeave += prevButton_MouseLeave;
        ...
        {
            // Add the global event handlers to the specified PictureBox
            pictureBox.MouseDown += prevButton_MouseDown;
            pictureBox.MouseUp += prevButton_MouseUp;
        }
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT COUNT(*) FROM tbl_NURSERYLANDANIMALS WHERE SoundID = @SoundId AND SoundData IS NOT NULL", connection))
            {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT SoundName, SoundData FROM tbl_NURSERYLANDANIMALS WHERE SoundID = @SoundId", connection))
            {
                cmd.Parameters.AddWithValue("@SoundId", soundId);
        ...
        private bool HasImageData(SqlConnection connection, int dataId)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("SELECT COUNT(*) FROM tbl_NURSERYLANDANIMALS WHERE SoundID = @DataId AND ImageData IS NOT NULL", connection))
            {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT ImageData FROM tbl_NURSERYLANDANIMALS WHERE SoundID = @DataId", connection))
            {
                cmd.Parameters.AddWithValue("@DataId", dataId);
        ...
        private void UpdateDataInDatabase(byte[] dataBytes, int rowId, string columnName)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string sqlQuery = $"UPDATE tbl_NURSERYLANDANIMALS SET {columnName} = @{columnName} WHERE SoundID = @ID";
        ...
        private void train()
        {
            ...
            if (!string.IsNullOrEmpty(defaultFileName))
            {
                ...
                Dname2.Text = fileNameWithoutExtension;
            }
            else
            {
                Dname2.Text = "No Sound Selected";
            }
        ...
        private void LoadablePnl1_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void LoadablePnl1_Paint_1(object sender, PaintEventArgs e)
        {
            ...
            if (label3.Text == "1")
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    try
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand("UPDATE tbl_NURSERYLANDANIMALS SET SoundName = @Name WHERE SoundID = @ID", connection))
                        {
        ...
        // Define a flag to track whether sound data has been saved
                ...
                if (!string.IsNullOrEmpty(textBox1.Text) && imageData != null)
                {
                    using (OpenFileDialog openFileDialog = new OpenFileDialog() { Filter = "Sound Files|*.wav;*.mp3|All Files|*.*" })
                    {
                        if (openFileDialog.ShowDialog() == DialogResult.OK)
                        {
                            ...
                            using (SqlConnection connection = new SqlConnection(connectionString))
                            using (SqlCommand cmd = new SqlCommand("UPDATE tbl_NURSERYLANDANIMALS SET SoundData = @SoundData WHERE SoundID = @ID", connection))
                            {
                                connection.Open();
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                // Call the method for the "Next" action
                nextButton_Click_1(sender, e);

            }

            // Check for the left arrow key (Previous)
            if (e.KeyCode == Keys.Left)
            {
                // Call the method for the "Previous" action
                prevButton_Click_1(sender, e);
            }
        }
        ...
        private byte[] RetrieveSoundDataFromDatabase(int soundId)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string sqlQuery = "SELECT SoundData FROM tbl_NURSERYLANDANIMALS WHERE SoundID = @ID";
        ...
        private string GetFilePathFromLoadableSounds(int soundID)
        {
            ...
            {
                connection.Open();
                SqlCommand cmd = new SqlCommand("SELECT SoundData FROM tbl_NURSERYLANDANIMALS WHERE SoundID = @SoundID", connection);
                cmd.Parameters.AddWithValue("@SoundID", soundID);
        ...
        private void DefaultSoundBtn2_Click_1(object sender, EventArgs e)
        {
        ...
        private void L2name_Click(object sender, EventArgs e)
        {

        }

        //NABALIK UNG IMAGE SA INSERT
        ...
        private byte[] imageData; // Class-level variable to hold the image data
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                using (SqlCommand cmd = new SqlCommand("SELECT SoundData FROM tbl_NURSERYLANDANIMALS WHERE SoundID = @SoundID", connection))
                {
                    cmd.Parameters.AddWithValue("@SoundID", soundID);
                    ...
                    using (SqlDataReader reader = cmd.ExecuteReader())
                    {
                        if (reader.Read() && !DBNull.Value.Equals(reader["SoundData"]))
                        {
                            PlaySound((byte[])reader["SoundData"]);
                        }
                        else
                        {


                            // Show the panel if there is no sound data
                            panel1.BringToFront();
                            panel1.Visible = true;
                        }
                    }
        ...
        private void Lpicture2_Click(object sender, EventArgs e)
        {
        ...
        private void Lsound5_Click(object sender, EventArgs e)
        {
            if (int.TryParse(label3.Text, out int soundID))
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
        ...
        private void Lsound6_Click(object sender, EventArgs e)
        {
            if (int.TryParse(label3.Text, out int soundID))
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
        ...
        private void Lsound7_Click(object sender, EventArgs e)
        {
            if (int.TryParse(label3.Text, out int soundID))
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
        ...
        private void Lsound8_Click(object sender, EventArgs e)
        {
            if (int.TryParse(label3.Text, out int soundID))
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
        ...
        private void Lsound9_Click(object sender, EventArgs e)
        {
            if (int.TryParse(label3.Text, out int soundID))
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
        ...
        private void Dpanel2_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void prevButton_Click(object sender, EventArgs e)
        {
            ...
            if (label3.Text == "D1")
            {
                ...
                //TEXT CHANGE
                Dname1.Font = new Font("Bowlby One SC", 28f, FontStyle.Regular);
            ...
            else if (label3.Text == "D2")
            {
                ...
                Dname2.Font = new Font("Bowlby One SC", 28f, FontStyle.Regular);
                Dname3.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            if (label3.Text == "D3")
            {
                ...
                Dname1.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Dname2.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Dname3.Font = new Font("Bowlby One SC", 28f, FontStyle.Regular);
                Dname4.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "D4")
            {
                ...
                Dname2.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Dname3.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Dname4.Font = new Font("Bowlby One SC", 28f, FontStyle.Regular);
                Dname5.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "D5")
            {
                ...
                Dname3.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Dname4.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Dname5.Font = new Font("Bowlby One SC", 28f, FontStyle.Regular);
                Lname1.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "1")
            {
                ...
                Dname4.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Dname5.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname1.Font = new Font("Bowlby One SC", 28f, FontStyle.Regular);
                Lname2.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "2")
            {
                ...
                Dname5.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname1.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname2.Font = new Font("Bowlby One SC", 28f, FontStyle.Regular);
                Lname3.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "3")
            {
                ...
                Lname1.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname2.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname3.Font = new Font("Bowlby One SC", 28f, FontStyle.Regular);
                Lname4.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "4")
            {
                ...
                Lname2.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname3.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname4.Font = new Font("Bowlby One SC", 28f, FontStyle.Regular);
                Lname5.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "5")
            {
                ...
                Lname3.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname4.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname5.Font = new Font("Bowlby One SC", 28f, FontStyle.Regular);
                Lname6.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "6")
            {
                ...
                Lname4.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname5.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname6.Font = new Font("Bowlby One SC", 28f, FontStyle.Regular);
                Lname7.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "7")
            {
                ...
                Lname5.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname6.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname7.Font = new Font("Bowlby One SC", 28f, FontStyle.Regular);
                Lname8.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "8")
            {
                ...
                Lname6.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname7.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname8.Font = new Font("Bowlby One SC", 28f, FontStyle.Regular);
                Lname9.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "9")
            {
                ...
                Lname7.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname8.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname9.Font = new Font("Bowlby One SC", 28f, FontStyle.Regular);
                Lname10.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "10")
            {
                ...
                Lname8.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname9.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname10.Font = new Font("Bowlby One SC", 28f, FontStyle.Regular);
        ...
        private void nextButton_Click(object sender, EventArgs e)
        {
            ...
            // LoadablePnl5 in panelcontainer4
        ...
        private void lbutton3_Click_1(object sender, EventArgs e)
        {
        ...
        private void lbutton10_Click_1(object sender, EventArgs e)
        {
        ...
        private void pictureBox1_Click_6(object sender, EventArgs e)
        {
            if (int.TryParse(label3.Text, out int soundID))
            {
                ...
                else
                {
                    ...
                    using (SqlConnection connection = new SqlConnection(connectionString))
                    using (SqlCommand cmd = new SqlCommand("UPDATE tbl_NURSERYLANDANIMALS SET ImageData = @ImageData WHERE SoundID = @ID", connection))
                    {
                        try
                        {
                            connection.Open();
                    ...
                    else if (label3.Text == "2")
                    {
                        using (SqlConnection connection = new SqlConnection(connectionString))
                        {
                            try
                            {
                                ...
                                // Update the Name in tbl_NURSERYLANDANIMALS
                                using (SqlCommand cmd = new SqlCommand("UPDATE tbl_NURSERYLANDANIMALS SET SoundName = @Name WHERE SoundID = @ID", connection))
                                {
                                    cmd.Parameters.AddWithValue("@Name", soundName);
                                    cmd.Parameters.AddWithValue("@ID", 2); // Adjust the ID based on your condition
        ...
        private void pictureBox2_Click_1(object sender, EventArgs e)
        {
            ...
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                using (SqlCommand cmd = new SqlCommand("UPDATE tbl_NURSERYLANDANIMALS SET SoundData = NULL, ImageData = NULL WHERE SoundID = @ID", connection))
                {
                    try
                    {
                        connection.Open();
        ...
        {
            _1SubAnimals frm1 = new _1SubAnimals();
            frm1.Show();
            this.Hide();
        }
        ...
        private void pictureBox1_Click_7(object sender, EventArgs e)
        {
