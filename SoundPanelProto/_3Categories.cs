...
{
    public partial class _3Categories : Form
    {
        public _3Categories()
        {
            InitializeComponent();
        ...
        {
            _3Alphabets frm5 = new _3Alphabets();
            this.Hide();
            frm5.Show();
        }
        ...
        {
            _3Vehicles frm5 = new _3Vehicles();
            this.Hide();
            frm5.Show();
        }
    }
