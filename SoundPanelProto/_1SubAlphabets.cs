...
{
    public partial class _1SubAlphabets : Form
    {
        private ABCAlphabets Alpha;
        public _1SubAlphabets()
        {
            InitializeComponent();
        ...
        {
            _1Categories frm5 = new _1Categories();
            this.Hide();
            frm5.Show();
        }
        ...
        {
            VOWELSalphabets frm1 = new VOWELSalphabets();
            frm1.Show();
            this.Hide();
        }
    }
