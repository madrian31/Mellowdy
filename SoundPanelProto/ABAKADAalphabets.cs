...
{
    public partial class ABAKADAalphabets : Form
    {
        ...
        {
            _2SubAlphabets frm1 = new _2SubAlphabets();
            frm1.Show();
            this.Hide();
        }
        ...
        private string GetFilePathBySoundID(int soundID)
        {
            ...
            connection.Open();
            SqlCommand cmd = new SqlCommand("SELECT SoundData FROM tbl_Abakada WHERE SoundID = @SoundID", connection);
