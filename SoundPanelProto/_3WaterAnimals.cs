...
{
    public partial class _3WaterAnimals : Form
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT COUNT(*) FROM tbl_PREPARATORYWATERANIMALS WHERE SoundID = @SoundId AND SoundData IS NOT NULL", connection))
            {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT SoundName, SoundData FROM tbl_PREPARATORYWATERANIMALS WHERE SoundID = @SoundId", connection))
            {
                cmd.Parameters.AddWithValue("@SoundId", soundId);
        ...
        private bool HasImageData(SqlConnection connection, int dataId)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("SELECT COUNT(*) FROM tbl_PREPARATORYWATERANIMALS WHERE SoundID = @DataId AND ImageData IS NOT NULL", connection))
            {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("SELECT ImageData FROM tbl_PREPARATORYWATERANIMALS WHERE SoundID = @DataId", connection))
            {
                cmd.Parameters.AddWithValue("@DataId", dataId);
        ...
        private void UpdateDataInDatabase(byte[] dataBytes, int rowId, string columnName)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string sqlQuery = $"UPDATE tbl_PREPARATORYWATERANIMALS SET {columnName} = @{columnName} WHERE SoundID = @ID";
        ...
        private byte[] RetrieveSoundDataFromDatabase(int soundId)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string sqlQuery = "SELECT SoundData FROM tbl_PREPARATORYWATERANIMALS WHERE SoundID = @ID";
        ...
        private string GetFilePathFromLoadableSounds(int soundID)
        {
            ...
            {
                connection.Open();
                SqlCommand cmd = new SqlCommand("SELECT SoundData FROM tbl_PREPARATORYWATERANIMALS WHERE SoundID = @SoundID", connection);
                cmd.Parameters.AddWithValue("@SoundID", soundID);
        ...
        private void prevButton_Click(object sender, EventArgs e)
        {
            ...
            if (label3.Text == "D1")
            {
                ...
                //TEXT CHANGE
                Dname1.Font = new Font("Bowlby One SC", 20f, FontStyle.Regular);
            ...
            else if (label3.Text == "D2")
            {
                ...
                Dname2.Font = new Font("Bowlby One SC", 20f, FontStyle.Regular);
                Dname3.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            if (label3.Text == "D3")
            {
                ...
                Dname1.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Dname2.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Dname3.Font = new Font("Bowlby One SC", 20f, FontStyle.Regular);
                Dname4.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "D4")
            {
                ...
                Dname2.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Dname3.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Dname4.Font = new Font("Bowlby One SC", 20f, FontStyle.Regular);
                Dname5.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "D5")
            {
                ...
                Dname3.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Dname4.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Dname5.Font = new Font("Bowlby One SC", 20f, FontStyle.Regular);
                Lname1.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "1")
            {
                ...
                Dname4.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Dname5.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname1.Font = new Font("Bowlby One SC", 20f, FontStyle.Regular);
                Lname2.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "2")
            {
                ...
                Dname5.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname1.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname2.Font = new Font("Bowlby One SC", 20f, FontStyle.Regular);
                Lname3.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "3")
            {
                ...
                Lname1.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname2.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname3.Font = new Font("Bowlby One SC", 20f, FontStyle.Regular);
                Lname4.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "4")
            {
                ...
                Lname2.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname3.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname4.Font = new Font("Bowlby One SC", 20f, FontStyle.Regular);
                Lname5.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "5")
            {
                ...
                Lname3.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname4.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname5.Font = new Font("Bowlby One SC", 20f, FontStyle.Regular);
                Lname6.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "6")
            {
                ...
                Lname4.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname5.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname6.Font = new Font("Bowlby One SC", 20f, FontStyle.Regular);
                Lname7.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "7")
            {
                ...
                Lname5.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname6.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname7.Font = new Font("Bowlby One SC", 20f, FontStyle.Regular);
                Lname8.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "8")
            {
                ...
                Lname6.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname7.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname8.Font = new Font("Bowlby One SC", 20f, FontStyle.Regular);
                Lname9.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "9")
            {
                ...
                Lname7.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname8.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname9.Font = new Font("Bowlby One SC", 20f, FontStyle.Regular);
                Lname10.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
            ...
            else if (label3.Text == "10")
            {
                ...
                Lname8.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname9.Font = new Font("Bowlby One SC", 12f, FontStyle.Regular);
                Lname10.Font = new Font("Bowlby One SC", 20f, FontStyle.Regular);
                ...
                if (!string.IsNullOrEmpty(textBox1.Text) && imageData != null)
                {
                    using (OpenFileDialog openFileDialog = new OpenFileDialog() { Filter = "Sound Files|*.wav;*.mp3|All Files|*.*" })
                    {
                        if (openFileDialog.ShowDialog() == DialogResult.OK)
                        {
                            ...
                            using (SqlConnection connection = new SqlConnection(connectionString))
                            using (SqlCommand cmd = new SqlCommand("UPDATE tbl_PREPARATORYWATERANIMALS SET SoundData = @SoundData WHERE SoundID = @ID", connection))
                            {
                                connection.Open();
        ...
        private void InsertBtn_Click(object sender, EventArgs e)
        {
            if (int.TryParse(label3.Text, out int soundID))
            {
                ...
                else
                {
                    ...
                    using (SqlConnection connection = new SqlConnection(connectionString))
                    using (SqlCommand cmd = new SqlCommand("UPDATE tbl_PREPARATORYWATERANIMALS SET ImageData = @ImageData WHERE SoundID = @ID", connection))
                    {
                        try
                        {
                            connection.Open();
                    ...
                    if (updateSuccessful && label3.Text == "1")
                    {
                        using (SqlConnection connection = new SqlConnection(connectionString))
                        {
                            try
                            {
                                ...
                                using (SqlCommand cmd = new SqlCommand("UPDATE tbl_PREPARATORYWATERANIMALS SET SoundName = @Name WHERE SoundID = @ID", connection))
                                {
                    ...
                    else if (label3.Text == "2")
                    {
                        using (SqlConnection connection = new SqlConnection(connectionString))
                        {
                            try
                            {
                                ...
                                // Update the Name in tbl_PREPARATORYWATERANIMALS
                                using (SqlCommand cmd = new SqlCommand("UPDATE tbl_PREPARATORYWATERANIMALS SET SoundName = @Name WHERE SoundID = @ID", connection))
                                {
                                    cmd.Parameters.AddWithValue("@Name", soundName);
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                using (SqlCommand cmd = new SqlCommand("UPDATE tbl_PREPARATORYWATERANIMALS SET SoundData = NULL, ImageData = NULL WHERE SoundID = @ID", connection))
                {
                    try
                    {
                        connection.Open();
