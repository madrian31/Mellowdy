...
{
    public partial class _2Vehicles : Form
    {
        public _2Vehicles()
        {
            InitializeComponent();
        ...
        {
            _2LandVehicles frm5 = new _2LandVehicles();
            this.Hide();
            frm5.Show();
        }
        ...
        {
            _2WaterVehicles frm5 = new _2WaterVehicles();
            this.Hide();
            frm5.Show();
        }
        ...
        {
            _2AerialVehicles frm5 = new _2AerialVehicles();
            this.Hide();
            frm5.Show();
        }
    }
